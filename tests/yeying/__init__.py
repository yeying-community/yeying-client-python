...
block_address = decrypt_block_address(identity.blockAddress, identity.securityConfig.algorithm, "Aa123456")
print(f"block_address={block_address}")
proxy = os.environ.get("WAREHOUSE_ENDPOINT", "http://47.116.193.171:8641")
