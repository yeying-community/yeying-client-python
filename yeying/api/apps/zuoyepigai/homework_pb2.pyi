...
class HomeworkListRequest(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_message_pb2.MessageHeader, _Mapping]] = ..., body: _Optional[_Union[HomeworkListRequestBody, _Mapping]] = ...) -> None: ...
...
class HomeworkListResponse(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_message_pb2.MessageHeader, _Mapping]] = ..., body: _Optional[_Union[HomeworkListResponseBody, _Mapping]] = ...) -> None: ...
...
class HomeworkListResponseBody(_message.Message):
    ...
    def __init__(self, status: _Optional[_Union[_message_pb2.ResponseStatus, _Mapping]] = ..., list: _Optional[_Iterable[_Union[_meta_pb2.HomeworkMetadata, _Mapping]]] = ...) -> None: ...
...
class HomeworkDetailRequest(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_message_pb2.MessageHeader, _Mapping]] = ..., body: _Optional[_Union[HomeworkDetailRequestBody, _Mapping]] = ...) -> None: ...
...
class HomeworkDetailResponse(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_message_pb2.MessageHeader, _Mapping]] = ..., body: _Optional[_Union[HomeworkDetailResponseBody, _Mapping]] = ...) -> None: ...
...
class HomeworkDetailResponseBody(_message.Message):
    ...
    def __init__(self, status: _Optional[_Union[_message_pb2.ResponseStatus, _Mapping]] = ..., meta: _Optional[_Union[_meta_pb2.HomeworkMetadata, _Mapping]] = ...) -> None: ...
