...
class DetailWarehouseRequest(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_message_pb2.MessageHeader, _Mapping]] = ..., body: _Optional[_Union[DetailWarehouseRequestBody, _Mapping]] = ...) -> None: ...
...
class DetailWarehouseResponse(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_message_pb2.MessageHeader, _Mapping]] = ..., body: _Optional[_Union[DetailWarehouseResponseBody, _Mapping]] = ...) -> None: ...
...
class DetailWarehouseResponseBody(_message.Message):
    ...
    def __init__(self, status: _Optional[_Union[_message_pb2.ResponseStatus, _Mapping]] = ..., meta: _Optional[_Union[_meta_pb2.WarehouseMetadata, _Mapping]] = ...) -> None: ...
...
class AddWarehouseRequest(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_message_pb2.MessageHeader, _Mapping]] = ..., body: _Optional[_Union[AddWarehouseRequestBody, _Mapping]] = ...) -> None: ...
...
class AddWarehouseResponse(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_message_pb2.MessageHeader, _Mapping]] = ..., body: _Optional[_Union[AddWarehouseResponseBody, _Mapping]] = ...) -> None: ...
...
class ListWarehouseRequest(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_message_pb2.MessageHeader, _Mapping]] = ..., body: _Optional[_Union[ListWarehouseRequestBody, _Mapping]] = ...) -> None: ...
...
class ListWarehouseRequestBody(_message.Message):
    ...
    def __init__(self, did: _Optional[str] = ..., taskUid: _Optional[str] = ..., pageIndex: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]] = ..., pageSize: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]] = ...) -> None: ...
...
class ListWarehouseResponse(_message.Message):
    ...
    def __init__(self, header: _Optional[_Union[_message_pb2.MessageHeader, _Mapping]] = ..., body: _Optional[_Union[ListWarehouseResponseBody, _Mapping]] = ...) -> None: ...
...
class ListWarehouseResponseBody(_message.Message):
    ...
    total: int
    def __init__(self, status: _Optional[_Union[_message_pb2.ResponseStatus, _Mapping]] = ..., list: _Optional[_Iterable[_Union[_meta_pb2.WarehouseMetadata, _Mapping]]] = ..., total: _Optional[int] = ...) -> None: ...
