...
class SearchRequest(_message.Message):
    ...
    def __init__(self, owner: _Optional[str] = ..., conditionList: _Optional[_Iterable[_Union[Condition, _Mapping]]] = ...) -> None: ...
...
class PluginItem(_message.Message):
    ...
    code: str
    timestamp: int
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., version: _Optional[str] = ..., code: _Optional[str] = ..., timestamp: _Optional[int] = ...) -> None: ...
...
class InstallRequest(_message.Message):
    ...
    code: str
    extend: str
    def __init__(self, owner: _Optional[str] = ..., version: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., code: _Optional[str] = ..., extend: _Optional[str] = ...) -> None: ...
