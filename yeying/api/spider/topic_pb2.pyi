...
class SearchResponse(_message.Message):
    ...
    def __init__(self, status: _Optional[_Union[_message_pb2.ResponseStatus, _Mapping]] = ..., topicMetadata: _Optional[_Iterable[_Union[TopicMetadata, _Mapping]]] = ...) -> None: ...
...
class TopicMetadata(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., format: _Optional[_Iterable[_Union[_code_pb2.DigitalFormatEnum, str]]] = ..., expression: _Optional[str] = ..., status: _Optional[_Union[_code_pb2.ContractStatusEnum, str]] = ...) -> None: ...
...
class SubscribeRequest(_message.Message):
    ...
    owner: str
    topicMetadata: _containers.RepeatedCompositeFieldContainer[TopicMetadata]
    def __init__(self, owner: _Optional[str] = ..., topicMetadata: _Optional[_Iterable[_Union[TopicMetadata, _Mapping]]] = ...) -> None: ...
